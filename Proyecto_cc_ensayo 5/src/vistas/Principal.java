...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 200, 230, 60));
        ...
        jPanel1.add(btnSesion, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 10, 140, 40));
        ...
        jMenu4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/trofeo.png"))); // NOI18N
        ...
        jMenuItem7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/trofeo.png"))); // NOI18N
        jMenuItem7.setText("Concurso");
        ...
        jMenu5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/mantenimiento.png"))); // NOI18N
        jMenu5.setText("Mantenimiento");

        jMenuItem8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/mantenimiento.png"))); // NOI18N
    ...
    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
        GestionarPersonalGeren gp;
        try {
            gp = new GestionarPersonalGeren();
            gp.setLocationRelativeTo(null);
            gp.setVisible(true);
            gp.setTitle(("Gestión de Productos").toUpperCase());
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        GestionarLocales gpro;
        try {
            gpro = new GestionarLocales();
            gpro.setLocationRelativeTo(null);
            gpro.setVisible(true);
            gpro.setTitle(("Gestiónar locales").toUpperCase());
    ...
    private void jMenuItem7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem7ActionPerformed
        FrmConcurso concurso = null;
        try {
            concurso = new FrmConcurso();
        } catch (IOException ex) {
            Logger.getLogger(Principal.class.getName()).log(Level.SEVERE, null, ex);
        }
        concurso.setLocationRelativeTo(null);
        concurso.setVisible(true);
        concurso.setTitle(("Gestiónar locales").toUpperCase());
        concurso.setDefaultCloseOperation(0);
    }//GEN-LAST:event_jMenuItem7ActionPerformed

    private void jMenuItem8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem8ActionPerformed
        Mantenimiento1 mant = null;
        try {
            mant = new Mantenimiento1();
        } catch (IOException ex) {
            Logger.getLogger(Principal.class.getName()).log(Level.SEVERE, null, ex);
        }
        mant.setLocationRelativeTo(null);
        mant.setVisible(true);
        mant.setTitle(("Solicitudes de Mantenimiento").toUpperCase());

...
public class GestionarPersonalAdmin extends javax.swing.JFrame {
    ...
    public GestionarPersonalAdmin() throws IOException {
        initComponents();
        verificarArchivo();
        asignarEventoMouse();
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtCedula, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 60, 260, -1));

        txtNombre.setEnabled(false);
        jPanel1.add(txtNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 60, 270, -1));

        jLabel4.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        jLabel4.setText("Local");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 90, -1, -1));

        txtApellidos.setEnabled(false);
        jPanel1.add(txtApellidos, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 90, 260, -1));
        ...
        txtLocal.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        txtLocal.setEnabled(false);
        jPanel1.add(txtLocal, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 90, 270, -1));
        ...
        jPanel1.add(txtFechaNacimiento, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 120, 260, -1));
        ...
        jPanel1.add(txtDireccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 120, 270, -1));

        txtCelular.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        txtCelular.setEnabled(false);
        jPanel1.add(txtCelular, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 150, 260, -1));
        ...
        jPanel1.add(txtFechaIngreso, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 180, 260, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "Cédula", "Nombre", "Apellidos", "Local", "Fecha Nacimiento", "Dirección", "Celular", "Fecha Ingreso", "Cargo"
            }
        ) {
        ...
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 60, 80, -1));
        ...
        jPanel1.add(btnActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 280, 80, -1));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 210, 890, 50));

        jPanel3.setBackground(new java.awt.Color(51, 153, 255));
        jPanel3.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));

        btnCerrar1.setBackground(new java.awt.Color(255, 255, 255));
        btnCerrar1.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        btnCerrar1.setForeground(new java.awt.Color(0, 0, 0));
        btnCerrar1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/salir (1).png"))); // NOI18N
        ...
        jCombo1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Vendedor", "Enc. Inventario" }));
        jPanel1.add(jCombo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 150, 270, -1));
        ...
        jTable1.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent Mouse_event){
                ...
                if(Mouse_event.getClickCount()==2){
                    ...
                    txtApellidos.setText(""+tabla.getValueAt(tabla.getSelectedRow(), 3));
                    txtLocal.setText(""+tabla.getValueAt(tabla.getSelectedRow(), 4));
                    ...
                    txtFechaIngreso.setText(""+tabla.getValueAt(tabla.getSelectedRow(), 8));
    ...
    private void ingresarPersonal() throws FileNotFoundException, UnsupportedEncodingException, IOException{
        ...
        escribirArchivo.write(txtCedula.getText()+"\t"+txtNombre.getText()+"\t"+txtApellidos.getText()+"\t"+txtLocal.getText()+"\t"+txtFechaNacimiento.getText()
                +"\t"+txtDireccion.getText()+"\t"+txtCelular.getText()+"\t"+txtFechaIngreso.getText()+"\t"+jCombo1.getSelectedItem().toString()+"\n");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if (!(txtCedula.getText().equals("")||txtNombre.getText().equals("")||txtApellidos.getText().equals("")||txtLocal.getText().equals("")
                ||txtFechaNacimiento.getText().equals("")||txtDireccion.getText().equals("")||txtCelular.getText().equals("")||txtFechaIngreso.getText().equals(""))) {
    ...
    public void efectuarEdicion(){
        for (int i = 0; i < jTable1.getRowCount(); i++) {
            if(numeroEditar==Integer.parseInt((String)jTable1.getValueAt(i, 0))){
                ...
                jTable1.setValueAt(txtApellidos.getText(), i, 3);
                jTable1.setValueAt(txtLocal.getText(), i, 4);
                ...
                jTable1.setValueAt(txtFechaIngreso.getText(), i, 8);
                jTable1.setValueAt(jCombo1.getSelectedItem().toString(), i, 9);
                break;
            }
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionarPersonalAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new GestionarPersonalAdmin().setVisible(true);
                } catch (IOException ex) {
                    Logger.getLogger(GestionarPersonalAdmin.class.getName()).log(Level.SEVERE, null, ex);
                }
            }

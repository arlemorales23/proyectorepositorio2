...
public class SistemaCompras extends javax.swing.JFrame {
    ...
    public SistemaCompras() throws IOException {
        initComponents();
        verificarArchivo();
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnVerCompras, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 120, 110, 40));
        ...
        jPanel1.add(btnSeparar, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 210, 100, 30));
        ...
        jPanel1.add(btnVerSeparados, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 180, 110, 40));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 100, 150, 140));
    ...
    private void btnVerSeparadosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerSeparadosActionPerformed
        VerSeparados separar = null;
        try {
            separar = new VerSeparados();
        } catch (IOException ex) {
            Logger.getLogger(SistemaCompras.class.getName()).log(Level.SEVERE, null, ex);
        }

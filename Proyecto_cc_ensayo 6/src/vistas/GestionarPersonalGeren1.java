...
import modelo.Dao.PersonalLocalDao;

public class GestionarPersonalGeren1 extends javax.swing.JFrame {

    /**
     * Creates new form GestionarPersonal
     */
    File archivo = new File("PersonalLocal.txt");
    String opcionBoton = null;
    String numeroEditar = "";
    String numeroEliminar = "";
    PersonalLocalDao perDao = new PersonalLocalDao();

    public GestionarPersonalGeren1() throws IOException {
        initComponents();
        verificarArchivo();
        leerArchivo();
        asignarEventoMouse();
    ...
    private void initComponents() {
        ...
        combo1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Vendedor", "Inventario" }));
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        try {
            ...
            Logger.getLogger(GestionarPersonalGeren1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_btnActualizarActionPerformed

    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        try {
            // leemos lo que ya esta
            ArrayList<Usuario2> usuarios1 = perDao.leerArchivoFile();
            
            String local = buscarLocal();
            String[] data = new String[11];
            for (int j = 0; j < usuarios1.size(); j++) {
                if (numeroEliminar.equals(usuarios1.get(j).getUsuario())) {
                    usuarios1.remove(j);
                }    
            }
  
            if (perDao.insertarTodos(usuarios1)) {
        ...
        jTable1.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent Mouse_event) {
                ...
                if (Mouse_event.getClickCount() == 2) {
                    ...
                    numeroEditar = "" + tabla.getValueAt(tabla.getSelectedRow(), 3);
    ...
    private void ingresarPersonal() throws FileNotFoundException, UnsupportedEncodingException, IOException {
        ...
        if (!txtNombre.getText().isEmpty()
            ...
            String usuarioLogin = FrmLogin.txtUsuario.getText();
            String localBuscado = buscarLocal();
            Usuario2 x = new Usuario2(txtNombre.getText(), txtApellido.getText(), txtUsuario.getText(),
                    txtContraseña.getText(), txtCorreo.getText(), roles, localBuscado, usuarioLogin);

            if (perDao.insertar(x)) {
                JOptionPane.showMessageDialog(null, "Personal ingresado correctamente");
            } else {
                JOptionPane.showMessageDialog(null, "no se pudo ");
            }
    ...
    private void ingresarPersonal2l() throws FileNotFoundException, UnsupportedEncodingException, IOException {
        // leemos lo que ya esta
        ArrayList<Usuario2> usuarios1 = perDao.leerArchivoFile();
        ...
        String[] data = new String[11];
        for (int j = 0; j < usuarios1.size(); j++) {
            if (numeroEditar.equals(usuarios1.get(j).getUsuario())) {
               usuarios1.remove(j);
            }
    ...
    public void efectuarEdicion() {
        ...
        for (int i = 0; i < jTable1.getRowCount(); i++) {
            if (numeroEditar.equals(jTable1.getValueAt(i, 4))) {
                jTable1.setValueAt(numeroEditar, i, 4);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionarPersonalGeren1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new GestionarPersonalGeren1().setVisible(true);
                } catch (IOException ex) {
                    Logger.getLogger(GestionarPersonalGeren1.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    public void leerArchivo() throws FileNotFoundException, IOException {
        ...
        String[] data = new String[11];
        for (int j = 0; j < usuarios1.size(); j++) {
            data[0] = String.valueOf(j + 1);
            data[1] = usuarios1.get(j).getNombres();
            data[2] = usuarios1.get(j).getApellidos();
            data[3] = usuarios1.get(j).getUsuario();
            data[4] = usuarios1.get(j).getContraseña();
            data[5] = usuarios1.get(j).getCorreo();
            data[6] = usuarios1.get(j).getRol();
            if (local.equals(usuarios1.get(j).getLocal())) {
                modelo.addRow(data);
            }

...
public class GestionarPersonalAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtCedula, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 60, 180, -1));
        ...
        jPanel1.add(txtApellidos, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 90, 180, -1));
        ...
        jPanel1.add(txtLocal, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 90, 180, -1));
        ...
        txtCargo.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        txtCargo.setEnabled(false);
        jPanel1.add(txtCargo, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 120, 180, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cedula", "Nombre", "Apellidos", "Celular", "Fecha Ingreso", "Cargo", "Local"
            }
        ) {
        ...
        jTable1.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent Mouse_event) {
                ...
                if (Mouse_event.getClickCount() == 2) {
                    ...
                    txtCedula.setText("" + tabla.getValueAt(tabla.getSelectedRow(), 0));
                    txtNombre.setText("" + tabla.getValueAt(tabla.getSelectedRow(), 1));
                    txtApellidos.setText("" + tabla.getValueAt(tabla.getSelectedRow(), 2));
                    txtLocal.setText("" + tabla.getValueAt(tabla.getSelectedRow(), 3));
                    txtPrecioUnidad.setText("" + tabla.getValueAt(tabla.getSelectedRow(), 4));
                    txtCargo.setText("" + tabla.getValueAt(tabla.getSelectedRow(), 5));
    ...
    private void ingresarProducto() throws FileNotFoundException, UnsupportedEncodingException, IOException {
        ...
        escribirArchivo.write(txtCedula.getText() + "\t" + txtNombre.getText() + "\t" + txtApellidos.getText() + "\t" + txtLocal.getText() + "\t"
                + txtPrecioUnidad.getText() + "\t" + txtCargo.getText() + "\t" + local + "\n");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (!(txtCedula.getText().equals("") || txtNombre.getText().equals("") || txtApellidos.getText().equals("")
                || txtLocal.getText().equals("") || txtPrecioUnidad.getText().equals("") || txtCargo.getText().equals(""))) {
    ...
    public void almacenarFichero() throws IOException {
        ...
        for (int i = 0; i < jTable1.getRowCount(); i++) {
            ...
            if (numeroEditar == temporal) {
                ...
                jTable1.setValueAt(txtCedula.getText(), i, 0);
                jTable1.setValueAt(txtNombre.getText(), i, 1);
                jTable1.setValueAt(txtApellidos.getText(), i, 2);
                jTable1.setValueAt(txtLocal.getText(), i, 3);
                jTable1.setValueAt(txtPrecioUnidad.getText(), i, 4);
                jTable1.setValueAt(txtCargo.getText(), i, 5);

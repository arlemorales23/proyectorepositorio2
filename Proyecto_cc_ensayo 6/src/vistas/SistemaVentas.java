...
public class SistemaVentas extends javax.swing.JFrame {
    ...
    public SistemaVentas() throws IOException {
        initComponents();
        verificarArchivo();
    ...
    private void initComponents() {
        ...
        btnVerSeparados = new javax.swing.JButton();
        ...
        jPanel1.add(txtBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 300, 260, -1));
        ...
        jPanel1.add(btnBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 300, -1, -1));
        ...
        jPanel1.add(btnAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 260, 140, 30));
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 700, 180));
        ...
        jPanel1.add(btnEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 470, 100, 30));
        ...
        jPanel1.add(btnComprar, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 390, 100, 30));
        ...
        jPanel1.add(btnVerCompras, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 390, 110, 40));

        btnSeparar.setBackground(new java.awt.Color(0, 153, 255));
        btnSeparar.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        btnSeparar.setForeground(new java.awt.Color(255, 255, 255));
        btnSeparar.setText("Separar");
        btnSeparar.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        btnSeparar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSepararActionPerformed(evt);
            }
        });
        jPanel1.add(btnSeparar, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 430, 100, 30));

        btnVerSeparados.setBackground(new java.awt.Color(0, 102, 255));
        btnVerSeparados.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        btnVerSeparados.setForeground(new java.awt.Color(255, 255, 255));
        btnVerSeparados.setText("Ver Separados");
        btnVerSeparados.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        btnVerSeparados.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnVerSeparadosActionPerformed(evt);
            }
        });
        jPanel1.add(btnVerSeparados, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 450, 110, 40));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 370, 150, 140));
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        String Contador, ID, Nombre, Descripcion, Cantidad, Precio, Total, Local;
        ...
        if (tabla == -1) {
            ...
            Contador = jTable1.getValueAt(tabla, 0).toString();
            ID = jTable1.getValueAt(tabla, 1).toString();
            Nombre = jTable1.getValueAt(tabla, 2).toString();
            Descripcion = jTable1.getValueAt(tabla, 3).toString();
            Cantidad = jTable1.getValueAt(tabla, 4).toString();
            Precio = jTable1.getValueAt(tabla, 5).toString();
            Total = jTable1.getValueAt(tabla, 6).toString();
            Local = jTable1.getValueAt(tabla, 7).toString();

            DefaultTableModel modelo2 = (DefaultTableModel) jTable2.getModel();

            //n = (DefaultTableModel) jTable2.getModel();
            String filaelemento[] = {Contador, ID, Nombre, Descripcion, Cantidad, Precio, Total, Local};
            ...
            try {
                if (jTable2.getValueAt(i, 1) != null) {
                    escribirArchivo5.write(timestamp + "\t" + jTable2.getValueAt(i, 1) + "\t" + jTable2.getValueAt(i, 2)
                            ...
                            + "\t" + jTable2.getValueAt(i, 6) + "\t" + usuario1 + "\t" + jTable2.getValueAt(i, 7) + "\n");
                }
            } catch (IOException ex) {
                Logger.getLogger(SistemaVentas.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void btnVerSeparadosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerSeparadosActionPerformed
        VerSeparados2 separar2 = null;
        try {
            separar2 = new VerSeparados2();
        } catch (IOException ex) {
            Logger.getLogger(SistemaVentas.class.getName()).log(Level.SEVERE, null, ex);
        }
        separar2.setVisible(true);
    }//GEN-LAST:event_btnVerSeparadosActionPerformed
    ...
    private void btnSepararActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSepararActionPerformed
        ...
        try {
            try {
                escribirArchivo5 = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(separar, true), "utf-8"));
        ...
        try {
            escribirArchivo5.close();
            JOptionPane.showMessageDialog(null, "Separado realizado exitosamente");
            DefaultTableModel modelo2 = (DefaultTableModel) jTable2.getModel();
            limpiarTabla(modelo2);
        } catch (IOException ex) {
            Logger.getLogger(SistemaVentas.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void almacenarFichero() throws IOException {
        ...
        for (int i = 0; i < jTable1.getRowCount(); i++) {
            escribirArchivo.write(jTable1.getValueAt(i, 1) + "\t" + jTable1.getValueAt(i, 2) + "\t" + jTable1.getValueAt(i, 3)
                    + "\t" + jTable1.getValueAt(i, 4) + "\t" + jTable1.getValueAt(i, 5) + "\t" + jTable1.getValueAt(i, 6) + "\t" + jTable1.getValueAt(i, 7) + "\n");
        }
    ...
    private javax.swing.JButton btnVerSeparados;
